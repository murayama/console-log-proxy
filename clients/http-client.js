...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/client/http.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ \"./node_modules/core-js/modules/es.array.concat.js\");\n/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _overwrite_console__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./overwrite-console */ \"./src/client/overwrite-console.js\");\n\n\n\n\ntry {\n  var config = window.console_log_proxy_config || {};\n  var host = config.host || 'localhost';\n  var port = config.port || 8888;\n  var method = config.method || 'http';\n  var http = axios__WEBPACK_IMPORTED_MODULE_1___default.a.create({\n    baseURL: \"\".concat(method, \"://\").concat(host, \":\").concat([port]),\n    withCredentials: true\n  });\n  Object(_overwrite_console__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(function (data) {\n    // TODO: batch request\n    http.get(\"/console?event=\".concat(JSON.stringify(data))).then(function (res) {});\n  });\n} catch (err) {\n  if (window.orgConsole && typeof window.orgConsole.error == 'function') {\n    window.orgConsole.error.call(console, err);\n  }\n}\n\n//# sourceURL=webpack:///./src/client/http.js?");

/***/ }),

/***/ "./src/client/overwrite-console.js":
/*!*****************************************!*\
  !*** ./src/client/overwrite-console.js ***!
  \*****************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ \"./node_modules/core-js/modules/es.array.concat.js\");\n/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.object.get-own-property-names */ \"./node_modules/core-js/modules/es.object.get-own-property-names.js\");\n/* harmony import */ var core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_1__);\n\n\n\nvar overwriteConsole = function overwriteConsole(callback) {\n  var consoleMethods = ['debug', 'error', 'info', 'log', 'warn', 'dir', 'table'];\n  window.orgConsole = {};\n  var _arr = consoleMethods;\n\n  var _loop = function _loop() {\n    var method = _arr[_i];\n    window.orgConsole[method] = console[method];\n\n    console[method] = function () {\n      var _window$orgConsole$me;\n\n      for (var _len = arguments.length, data = new Array(_len), _key = 0; _key < _len; _key++) {\n        data[_key] = arguments[_key];\n      }\n\n      (_window$orgConsole$me = window.orgConsole[method]).call.apply(_window$orgConsole$me, [console].concat(data));\n\n      if (method == 'error') {\n        var json = JSON.stringify(data[0], Object.getOwnPropertyNames(data[0]));\n        data[0] = JSON.parse(json);\n      }\n\n      callback({\n        method: method,\n        data: data\n      });\n    };\n  };\n\n  for (var _i = 0; _i < _arr.length; _i++) {\n    _loop();\n  }\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (overwriteConsole);\n\n//# sourceURL=webpack:///./src/client/overwrite-console.js?");
